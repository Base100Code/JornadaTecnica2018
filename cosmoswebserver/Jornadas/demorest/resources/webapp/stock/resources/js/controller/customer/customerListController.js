(function () {
	...
	/**
	 * @ngdoc controller
	 * @name app.controller:customerListController
	 * @function
	 * 
	 * @description
	 *  Controller for customer list page 
	 */
 	angular.module('app').controller('app_customerListController', customerListController);

	function customerListController($state, $location, $q, $controller, app_comosDbService) {
		...
		function init(){
			app_comosDbService.setEntityConfig("customers", "customer");
